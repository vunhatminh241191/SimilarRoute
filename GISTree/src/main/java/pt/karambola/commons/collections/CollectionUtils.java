...
import pt.karambola.commons.util.ObjectUtils;
...
CollectionUtils
{
	...
	{
        if (collection == null)  throw new IllegalArgumentException( "The collection must not be null" ) ;
    ...
    public static <T>
    boolean
    addIgnoreNull( final Collection<T> collection, final T item )
    {
        if (collection == null)  throw new NullPointerException( "The collection must not be null" ) ;
    ...
    public static <T>
    boolean
    addAllIgnoreNull( final Collection<T> collection, final Iterable<? extends T> items)
    {
        boolean changed = false;
        
        for (final T item: items)
        	changed |= addIgnoreNull( collection, item ) ;
	...
	public static <T>
	boolean
	filter( final Iterable<T> collection, final Predicate<? super T> predicate )
	{
